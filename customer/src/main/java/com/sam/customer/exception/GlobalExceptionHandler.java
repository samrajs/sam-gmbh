...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private HttpStatus httpStatusOf(RuntimeException runtimeException) {
        if ( runtimeException instanceof CustomerAlreadyExists ) {
            return CustomerAlreadyExists.class.getAnnotation(ResponseStatus.class).value();
        }
        else if ( runtimeException instanceof ResourceNotFoundException ) {
            return ResourceNotFoundException.class.getAnnotation(ResponseStatus.class).value();
        }
        return HttpStatus.NOT_IMPLEMENTED;
    }
    @ExceptionHandler({CustomerAlreadyExists.class, ResourceNotFoundException.class})
