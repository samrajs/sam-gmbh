package com.sam.infrastructure.kafka.consumer.config;
...
import com.sam.infrastructure.kafka.config.data.KafkaConfigData;
import com.sam.infrastructure.kafka.config.data.KafkaConsumerConfigData;
