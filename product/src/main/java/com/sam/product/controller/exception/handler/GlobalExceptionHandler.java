package com.sam.product.controller.exception.handler;
...
import com.sam.product.controller.dto.ErrorResponseDto;
import com.sam.product.domain.exception.InvalidProductCategory;
import com.sam.product.domain.exception.ProductTooCostly;
import com.sam.product.domain.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({InvalidProductCategory.class, ResourceNotFoundException.class, ProductTooCostly.class, WrongProductStatus.class})
